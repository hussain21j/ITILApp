...
<body>
 	<div class="divBody">
		...
		<div class="divIncidentTrackDetails">
			<table border="1">
			<tr>
				<th>Sr No.</th>
				<th>Date</th>
				...
				<c:forEach  var = "incidentTrack" items="${listIncidentTrack}">
					<tr>
						<td><c:out value="${incidentTrack.incidentDetailId.serialNo}"></c:out> </td>
						<td><c:out value="${incidentTrack.actionTimestamp}"></c:out> </td>
						<td><c:out value="${incidentTrack.user.userFullName}"></c:out> </td>
						<td><c:out value="${incidentTrack.incidentStatus.statusCodeDesc}"></c:out> </td>
						<td><c:out value="${incidentTrack.logDescription}"></c:out> </td>
					</tr>
				</c:forEach>
		</div>
	</div>
